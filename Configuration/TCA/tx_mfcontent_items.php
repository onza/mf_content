...
return array (
  'ctrl' => 
  array (
    'title' => 'LLL:EXT:mf_content/Resources/Private/Language/locallang_db.xlf:tx_mfcontent_items',
    'label' => NULL,
    'tstamp' => 'tstamp',
    'crdate' => 'crdate',
    'cruser_id' => 'cruser_id',
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'foreign_table' => 'tx_mfcontent_items',
        'foreign_table_where' => 'AND tx_mfcontent_items.pid=###CURRENT_PID### AND tx_mfcontent_items.sys_language_uid IN (-1,0)',
        'default' => 0,
      ),
    ),
    'l10n_diffsource' => 
